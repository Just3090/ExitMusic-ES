...
translate spanish strings:
    ...
    new "Encuentra más traducciones en {a=https://traduction-club.live/}nuestra página web{/a}."

    # game/screens.rpy:767
    old "just6889 | Porteador y traductor (Traduction Club!)"
    new "just6889 | Porteador y traductor (Traduction Club!)"

    # game/screens.rpy:768
    old "Fran (franelcrack5366) | Traductor (Traduction Club!)"
    new "Fran (franelcrack5366) | Traductor (Traduction Club!)"
