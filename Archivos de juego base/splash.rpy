...
init python:
    ...
    splash_message_default = "This game is an unofficial fan work, created by Oliver Norton,\nJacob Smallman & Malukah Maker, and re-released by Wretched Team."
...
label splashscreen:
    ...
    $ config.main_menu_music = audio.decksdark
